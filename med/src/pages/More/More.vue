<template>
  <div>
    <div class="header">
        <div class="second">More Features</div>
    </div>
    <div class="main">
        <div class="row">
            ...
            <div class="block c2" @click="goTo('')">
                <img src="../../../public/images/traffic.png" alt="">
                <div class="text">公車動態</div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="block c1" @click="goTo('')">
                <img src="../../../public/images/discuss.png" alt="">
                <div class="text">討論專區</div>
            </div>
        </div>
        <div class="row">
...
export default {
    ...
    methods:{
        goTo(url){
            if(url=='') this.$bus.$emit('handleAlert','The function will be released soon','warning')
            else this.$router.replace(url);
        }
    }
}
</script>
